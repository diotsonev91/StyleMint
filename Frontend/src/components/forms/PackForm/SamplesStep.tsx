                                ...
                                <div className="sample-info">
                                    <div className="sample-header">
                                        <input
                                            ...
                                            disabled={isSubmitting || sample.isFromLibrary || sample.isAlreadyInPack}
                                        />
                                        {/* ✅ FIXED: Show appropriate badge */}
                                        {(sample.isFromLibrary || sample.isAlreadyInPack) && (
                                            <span className="existing-badge">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                                                {sample.isAlreadyInPack ? 'In Pack' : 'From Library'}
                      </span>
                                        )}
                                    </div>

...
// UPDATED: Import from centralized state file + ref
import { snapshot, useSnapshot, ref } from "valtio"; // ✅ Added ref
...
const Overlay = () => {
    ...
    useEffect(() => {
        if (location.state?.selectedType) {
            // Set the selected type from navigation state
            state.selected_type = location.state.selectedType;
            // Optionally set the page to basic customization
            state.page = "basic";
        }
    }, [location.state]);
    ...
    function uploadImageAsDecal() {
        ...
        input.onchange = (event) => {
            ...
            if (file) {
                ...
                // ✅ FIX: Use ref() to prevent File from being proxied
                state.customDecal = ref({
                    file,
                    previewUrl
                });
                ...
                // ✅ FIX: Also use ref() for userDesigns
                state.userDesigns.push(ref({
                    id: customDecalId,
                    file,
                    previewUrl,
    ...
    return (
        <>
            ...
            >
                ...
                {snap.page === "basic" ? "do it like a pro" : "do it easier"}
            </button>
